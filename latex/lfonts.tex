% File LFONTS - Version of 27 January 1985
% Changed to use fonts available on the Dover at Stanford.
% Don't believe the commented out font loads below for fonts at
% magnifications < 1000;  we have none of them.  Also, we don't
% have bold lasy fonts, and we don't have some fonts at magstep 3
% or above.
%      - changelfonts, version 2
%
% FONT CONVENTIONS
%
...
\def\@mcsc{cmcsc10}
\def\@mss{cmss10}
\def\@lasyb{lasy10} % Stanford: we have no lasyb fonts
...
\def\pit{\@subfont\it\fivmi}% Stanford
\def\psl{\@subfont\sl\it}%
\def\pbf{\@getfont\pbf\bffam\@vpt{cmbx5}}% Stanford
...
\def\pbf{\@getfont\pbf\bffam\@vipt{cmbx6}}% Stanford
\def\ptt{\@subfont\tt\rm}%
\def\psf{\@subfont\sf\rm}%
\def\psc{\@subfont\sc\rm}%
...
\def\psf{\@subfont\sf\rm}% Stanford
\def\psc{\@subfont\sc\rm}% Stanford
...
\def\unboldmath{\everymath{}\everydisplay{}\@nomath\unboldmath
          ...
          \@boldfalse}\@boldfalse
\def\boldmath{\@ifundefined{tenmib}{\global\font\tenmib\@mib 
...
\def\boldmath{\@ifundefined{elvmib}{\global\font\elvmib\@mib\@halfmag 
...
\def\unboldmath{\everymath{}\everydisplay{}\@nomath\unboldmath
          ...
          \@boldfalse}\@boldfalse
\def\boldmath{\@ifundefined{twlmib}{\global\font\twlmib\@mib\@magscale1\global
...
\def\boldmath{\@ifundefined{frtnmib}{\global\font
        \frtnmib\@mib\@magscale2\global\font\frtnsyb\@mbsy\@magscale2
...
\def\ptt{\@getfont\ptt\ttfam\@xivpt{cmtt10\@magscale2}}%
...
\def\ptt{\@getfont\ptt\ttfam\@xviipt{cmtt10\@magscale3}}%
\def\psf{\@subfont\sf\rm}% Stanford
\def\psc{\@subfont\sc\rm}% Stanford
...
\def\ptt{\@getfont\ptt\ttfam\@xxpt{cmtt10\@magscale4}}%
\def\psf{\@subfont\sf\rm}% Stanford
\def\psc{\@subfont\sc\rm}% Stanford
